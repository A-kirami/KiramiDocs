...
export default function HomepageHero() {
  ...
  return (
    <header className={clsx(styles.heroBanner)}>
      <HeroBackground />
      <div className="absolute z-9 w-full h-full backdrop-blur-60 flex flex-col justify-center items-center gap-3">
        <h1 className="hero__title font-size-18"> <span className="heading-line heading-line-first"><span className="heading-line-gradient">{siteConfig.title}</span></span></h1>
        <h2 className="hero__subtitle font-size-18"><span className="heading-line heading-line-second"
        ><span className="heading-line-gradient">简明轻快的</span></span></h2>
        <h2 className="hero__subtitle font-size-18"><span className="heading-line heading-line-third"
        ><span className="heading-line-gradient">聊天机器人应用</span></span></h2>
        <div className={styles.buttons}>
          <Link
            className="button--secondary button--lg text-white hover:text-white"
            to="/docs/intro">
